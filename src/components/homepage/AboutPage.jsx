  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <section className="relative py-20 px-6 md:px-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            About <span className="text-blue-200">DisasterAlert</span>
          </h1>
          ...
          <div className="mt-8 flex justify-center">
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-full px-6 py-3">
              <span className="text-blue-100 font-semibold">Next-Gen Disaster Intelligence for a Safer Tomorrow</span>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-800">Our Purpose</h3>
                </div>
      ...
      <section className="py-16 px-6 md:px-20 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Our Technology</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3">Machine Learning</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3">Satellite Data</h3>
                <p className="text-gray-600">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-800">Continuous Surveillance</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-800">Prediction Accuracy</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-800">Alert Speed</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-800">Worldwide Reach</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Research & Development</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">Community Partnership</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl mb-4">🌱</div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">Sustainable Future</h3>
              <p className="text-gray-600">
