...
const CycloneLineChart = ({ location }) => {
  ...
  useEffect(() => {
    fetch(`http://127.0.0.1:8000/feature/get_cyclone_data_json/?location=${location}`)
      .then((res) => res.json())
      .then((json) => {
    ...
    <div>
        ...
        options={{
            ...
            y2: {
                ...
                grid: { drawOnChartArea: false }, // only show grid for y1
            },
            },
        }}
        />
        ...
        <div className="overflow-x-auto mt-6">
            ...
            <div className="flex justify-center items-center mt-4 gap-2">
                <button
                    ...
                    className="px-3 py-1 by-gray-200 rounded disabled:opacity-50"
